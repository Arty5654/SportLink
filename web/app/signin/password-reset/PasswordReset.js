...
export default function PasswordReset({ onSent }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const r = await axios.post('http://localhost:5000/get_token', reqUser);
...
return (
    ...
    <div>
        ...
        <h4 className="flex justify-center text-center mb-12">A code will be sent to your email, please input that to be able to reset your password!</h4>
